...
FILES=main.o new_node.o delete_tree.o dump_tree.o search_in_tree.o definition_and_comparison.o launch_okinator.o play_in_okinator.o
TARGET = okinator
...
launch_okinator.o: src/launch_okinator.cpp
	@$(CC) -c $(FLAGS) src/launch_okinator.cpp -o build/launch_okinator.o

play_in_okinator.o: src/play_in_okinator.cpp
	@$(CC) -c $(FLAGS) src/play_in_okinator.cpp -o build/play_in_okinator.o
