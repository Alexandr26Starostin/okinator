...
FILES=main.o new_node.o delete_tree.o dump_tree.o search_in_tree.o definition_and_comparison.o read_database.o
...
read_database.o: src/read_database.cpp
	@$(CC) -c $(FLAGS) src/read_database.cpp -o build/read_database.o
